...
namespace UE4View.UE4
{
    public class ObjectVersion
    {
        ...
        public static Dictionary<string, EUnrealEngineObjectUE4Version> VersionDictionary { get => versionDictionary; set => versionDictionary = value; }
        ...
        public enum EUnrealEngineObjectUE4Version
        {
            ...
            VER_UE4_TemplateIndex_IN_COOKED_EXPORTS, // 4.14 base version
    ...
    private static Dictionary<string, EUnrealEngineObjectUE4Version> versionDictionary = new Dictionary<string, EUnrealEngineObjectUE4Version>()
        {
            ...
            { "4.2", EUnrealEngineObjectUE4Version.VER_UE4_FIX_MATERIAL_COORDS },
            { "4.3", EUnrealEngineObjectUE4Version.VER_UE4_FIX_MATERIAL_PROPERTY_OVERRIDE_SERIALIZE },
            { "4.4", EUnrealEngineObjectUE4Version.VER_UE4_BLUEPRINT_USE_SCS_ROOTCOMPONENT_SCALE },
            { "4.5", EUnrealEngineObjectUE4Version.VER_UE4_RENAME_CAMERA_COMPONENT_CONTROL_ROTATION },
            { "4.6", EUnrealEngineObjectUE4Version.VER_UE4_MOVEMENTCOMPONENT_AXIS_SETTINGS },
